      ...
      <article className="section article-page">
        <div className="container narrow prose">
          <section>
            ...
            <h2>Présentation et définition du projet</h2>
          ...
          <section>
            ...
            <h2>Objectifs, contexte, enjeux et risques</h2>
            <h3>Objectifs</h3>
          ...
          <section>
            ...
            <h2>Les acteurs et les interactions</h2>
            <ul className="check-list">
          ...
          <section>
            ...
            <h2>Les résultats — pour moi et pour l’entreprise</h2>
            <ul className="check-list">
